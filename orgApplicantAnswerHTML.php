...
<body class="theme-bg-color4">
      ...
      <nav>
          <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 ms-4 mx-4">
              ...
              <button id="backpageBtn"type="button" class="btn btn-sm noBorder theme-color8 btn-smartform3">
                  <span class="material-icons inline_icon"><-  Back to front page</span>
              </button>
          </div>
          ...
          <div class="nav nav-tabs theme-bg-color8 footerRadiusBorder d-flex justify-content-center" id="nav-dashboard-tab" role="tablist">
              <button class="nav-link active theme-color6" style="border-radius: 1rem 1rem 0rem 0rem;" id="nav-dashboard-tab" data-bs-toggle="tab"
                  ...
                  aria-selected="false" onfocus="navTabsNowFocus(this);"><span class="material-icons inline_icon">Applicant Answer</span></button>
          </div>
      </nav>
          ...
          <div class="tab-pane fade show active" id="nav-dashboard" role="tabpanel" aria-labelledby="nav-dashboard-tab">
              ...
              <main class="main-content">
                  <div class="container-fluid py-4">
                      ...
                      <div class="row mt-4">
                        <?php include 'orgDashBoxHTML/applicantAnswerDetail.php'; ?>
                          <div class="col-lg-5">
                              <!-- chart -->
                              <div class="card card-carousel overflow-hidden h-100 p-0">
                                  <div id="piechart">  <?php include 'orgDashBoxHTML/personalInfo.php'; ?></div>
                          </div>
                      </div>
